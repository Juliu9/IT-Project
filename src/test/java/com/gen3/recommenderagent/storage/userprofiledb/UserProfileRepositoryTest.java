...
class UserProfileRepositoryTest {
  ...
  void shouldSaveAndRetrieveUserProfile() {
    ...
    assertThat(userProfileDB.findById("user-123"))
        .isPresent()
        .hasValueSatisfying(retrieved -> assertThat(retrieved.getUserId()).isEqualTo("user-123"));
  }
  ...
  void shouldSaveMultiplePreferences() {
    ...
    assertThat(userProfileDB.findById("user-multiple-123"))
        .isPresent()
        .hasValueSatisfying(retrieved -> assertThat(retrieved.getPreferences()).hasSize(2));
  }
