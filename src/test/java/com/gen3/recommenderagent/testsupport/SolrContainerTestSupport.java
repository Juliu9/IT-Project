...
public final class SolrContainerTestSupport {
    ...
    private static void addField(
        ...
        new SchemaRequest.AddField(definition)
    ...
    private static SolrInputDocument book(
        ...
        document.addField(
                "all",
                title + " " + author + " " + searchableText + " " + description
        );
        return document;
    }
}
