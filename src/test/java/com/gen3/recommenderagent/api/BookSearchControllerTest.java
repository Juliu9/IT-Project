...
class BookSearchControllerTest {
    ...
    private final SolrAudiobookRepository repository =
            mock(SolrAudiobookRepository.class);
    private final BookSearchController controller =
    ...
    void shouldExposeMinimalHttpApi() throws Exception {
        ...
        QueryResponse queryResponse = mock(QueryResponse.class);
        when(queryResponse.getResults()).thenReturn(documents);
        when(repository.search("mystery", 5))
