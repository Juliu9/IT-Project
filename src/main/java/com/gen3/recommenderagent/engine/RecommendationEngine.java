...
public class RecommendationEngine {
  ...
  public List<Recommendation> process(
      String sessionId, String userId, SessionRequest currentRequest) {
    ...
    recommendations =
        (handler != null) ? handler.handle(currentRequest, session) : new ArrayList<>();
    ...
    eventPublisher.publish(new SessionUpdatedEvent(session));
